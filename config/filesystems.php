...
return [
    ...
    */
    ...
    'disks' => [
        ...
        // Disco dedicado para backups. Usar un bucket/almacenamiento distinto del
        // disco de producción para separar responsabilidades y mitigar riesgos
        // si el bucket principal se corrompe o se elimina por error.
        'backups' => [
            'driver' => 's3',

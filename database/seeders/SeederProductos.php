...
class SeederProductos extends Seeder
{
    public function run(): void
    {
        ...
        $brandMap = DB::table('marcas')->pluck('id', 'nombre')->toArray();
        ...
        DB::table('products')->insertOrIgnore($insert);
    }
}
